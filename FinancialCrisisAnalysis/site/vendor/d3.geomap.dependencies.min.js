! function() {
    ...
    function Pt() {
        var n, t = [];
        return {
            lineStart: function() { t.push(n = []) },
            point: function(t, e) { n.push([t, e]) },
            lineEnd: b,
            buffer: function() {
                var e = t;
                return t = [], n = null, e
            },
            rejoin: function() { t.length > 1 && t.push(t.pop().concat(t.shift())) }
        }
    }
    ...
    function Wt() {
        ...
        var u = Jt(4.5),
            ...
            a = {
                point: n,
                lineStart: function() { a.point = t },
                lineEnd: r,
                polygonStart: function() { a.lineEnd = i },
                polygonEnd: function() { a.lineEnd = r, a.point = n },
    ...
    function te(n) {
        ...
        var o = 4.5,
            a = {
                point: t,
                lineStart: function() { a.point = e },
                lineEnd: i,
                polygonStart: function() { a.lineEnd = u },
                polygonEnd: function() { a.lineEnd = i, a.point = t },
                pointRadius: function(n) {
                    return o = n, a
                },
                result: b
    ...
    function ee(n) {
        ...
        function e(t) {
            return ue(t, function(e, r) { e = n(e, r), t.point(e[0], e[1]) })
        }
    ...
    function ue(n, t) {
        return { point: t, sphere: function() { n.sphere() }, lineStart: function() { n.lineStart() }, lineEnd: function() { n.lineEnd() }, polygonStart: function() { n.polygonStart() }, polygonEnd: function() { n.polygonEnd() } }
    }
    ...
    function le(n) {
        return ue(n, function(t, e) { n.point(t * Yo, e * Yo) })
    }
    ...
    var ao = { version: "3.5.17" },
        ...
        fo = this.document;
    if (fo) try { co(fo.documentElement.childNodes)[0].nodeType } catch (so) {
        co = function(n) {
    ...
    if (Date.now || (Date.now = function() {
            return +new Date
        }), fo) try { fo.createElement("DIV").style.setProperty("opacity", 0, "") } catch (ho) {
    ...
    l(c, {
        ...
        function n(t, o, a) {
            ...
            return t ? (f = t(), s = function(e, r) { f.set(e, n(t, r, a)) }) : (f = {}, s = function(e, r) { f[e] = n(t, r, a) }), d.forEach(s), f
        }
        ...
        function t(n, e) {
            ...
            var r = [],
                i = o[e++];
            return n.forEach(function(n, i) { r.push({ key: n, values: t(i, e) }) }), i ? r.sort(function(n, t) {
    ...
    var So = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,
        ko = {}.__proto__ ? function(n, t) { n.__proto__ = t } : function(n, t) {
    ...
    ao.interpolateZoom = function(n, t) {
        ...
        function h() {
            function n() {
                var n = ao.touches(g);
                return p = k.k, n.forEach(function(n) { n.identifier in d && (d[n.identifier] = e(n)) }), n
            }
    ...
    ao.timer = function() { qn.apply(this, arguments) }, ao.timer.flush = function() { Rn(), Dn() }, ao.round = function(n, t) {
    ...
    Hn.prototype = {
        ...
        setDate: function() { da.setUTCDate.apply(this._, arguments) },
        setDay: function() { da.setUTCDay.apply(this._, arguments) },
        setFullYear: function() { da.setUTCFullYear.apply(this._, arguments) },
        setHours: function() { da.setUTCHours.apply(this._, arguments) },
        setMilliseconds: function() { da.setUTCMilliseconds.apply(this._, arguments) },
        setMinutes: function() { da.setUTCMinutes.apply(this._, arguments) },
        setMonth: function() { da.setUTCMonth.apply(this._, arguments) },
        setSeconds: function() { da.setUTCSeconds.apply(this._, arguments) },
        setTime: function() { da.setTime.apply(this._, arguments) }
    };
    var da = Date.prototype;
    ga.year = On(function(n) {
        return n = ga.day(n), n.setMonth(0, 1), n
    }, function(n, t) { n.setFullYear(n.getFullYear() + t) }, function(n) {
        return n.getFullYear()
    }), ga.years = ga.year.range, ga.years.utc = ga.year.utc.range, ga.day = On(function(n) {
        var t = new va(2e3, 0);
        return t.setFullYear(n.getFullYear(), n.getMonth(), n.getDate()), t
    }, function(n, t) { n.setDate(n.getDate() + t) }, function(n) {
        return n.getDate() - 1
        ...
        }, function(n, t) { n.setDate(n.getDate() + 7 * Math.floor(t)) }, function(n) {
    ...
    ao.format = xa.numberFormat, ao.geo = {}, ft.prototype = {
        s: 0,
        t: 0,
        add: function(n) { st(n, this.t, ba), st(ba.s, this.s, this), this.s ? this.t += ba.t : this.s = ba.t },
    ...
    var _a = {
            Feature: function(n, t) { ht(n.geometry, t) },
            FeatureCollection: function(n, t) {
                for (var e = n.features, r = -1, i = e.length; ++r < i;) ht(e[r].geometry, t)
            }
        },
        wa = {
            Sphere: function(n, t) { t.sphere() },
            Point: function(n, t) { n = n.coordinates, t.point(n[0], n[1], n[2]) },
            MultiPoint: function(n, t) {
                for (var e = n.coordinates, r = -1, i = e.length; ++r < i;) n = e[r], t.point(n[0], n[1], n[2])
            },
            LineString: function(n, t) { pt(n.coordinates, t, 0) },
            MultiLineString: function(n, t) {
                for (var e = n.coordinates, r = -1, i = e.length; ++r < i;) pt(e[r], t, 0)
            },
            Polygon: function(n, t) { gt(n.coordinates, t) },
    ...
    }, ie.prototype = { point: function(n, t) { this.stream.point(n, t) }, sphere: function() { this.stream.sphere() }, lineStart: function() { this.stream.lineStart() }, lineEnd: function() { this.stream.lineEnd() }, polygonStart: function() { this.stream.polygonStart() }, polygonEnd: function() { this.stream.polygonEnd() } }, ao.geo.projection = oe, ao.geo.projectionMutator = ae, (ao.geo.equirectangular = function() {
        return oe(ce)
    ...
    ao.geom.delaunay = function(n) {
        ...
        function u(n) {
            ...
            w > S ? m = d + w : y = v + S;
            var k = hr();
            if (k.add = function(n) { u(k, n, +M(n, ++p), +x(n, p), v, d, y, m) }, k.visit = function(n) { pr(n, k, v, d, y, m) }, k.find = function(n) {
    ...
    ao.layout.hierarchy = function() {
        ...
        function n(o) {
            ...
            return null != e && d.sort(e === bl ? function(n, t) {
                ...
                return e(o[n], o[t])
            }), d.forEach(function(n) { y[n] = { data: o[n], value: a = c[n], startAngle: f, endAngle: f += a * v + p, padAngle: h } }), y
        }
        var t = Number,
            e = bl,
            r = 0,
    ...
    Yl.call = Co.call, Yl.empty = Co.empty, Yl.node = Co.node, Yl.size = Co.size, ao.transition = function(n, t) {
        ...
        function i(n) {
            return null == n ? e : (n += "", function() {
                ...
                return e !== n && (t = o(e, n), function(n) { this.setAttribute(a, t(n)) })
            })
        }
        ...
        function u(n) {
            return null == n ? r : (n += "", function() {
                ...
                return e !== n && (t = o(e, n), function(n) { this.setAttributeNS(a.space, a.local, t(n)) })
            })
        }
        if (arguments.length < 2) {
        ...
        function e(n, e) {
            ...
            return r && function(n) { this.setAttribute(i, r(n)) }
        }

        function r(n, e) {
            var r = t.call(this, n, e, this.getAttributeNS(i.space, i.local));
            return r && function(n) { this.setAttributeNS(i.space, i.local, r(n)) }
        }
        ...
        function u(e) {
            return null == e ? i : (e += "", function() {
                ...
                return u !== e && (i = Mr(u, e), function(t) { this.style.setProperty(n, i(t), r) })
            })
        }
        ...
        function i(i, u) {
            ...
            return o && function(t) { this.style.setProperty(n, o(t), r) }
        }
        ...
        for (var n, t, e, r, i = this.id, u = ++Zl, o = this.namespace, a = [], l = 0, c = this.length; c > l; l++) {
            a.push(n = []);
            for (var t = this[l], f = 0, s = t.length; s > f; f++)(e = t[f]) && (r = e[o][i], Qu(e, f, o, u, { time: r.time, ease: r.ease, delay: r.delay + r.duration, duration: r.duration })), n.push(e)
        }
        return Wu(a, o, u)
    ...
    }, function(n, t) { n.setTime(n.getTime() + 1e3 * Math.floor(t)) }, function(n) {
        return n.getSeconds()
    }), ga.seconds = ga.second.range, ga.seconds.utc = ga.second.utc.range, ga.minute = On(function(n) {
        return new va(6e4 * Math.floor(n / 6e4))
    }, function(n, t) { n.setTime(n.getTime() + 6e4 * Math.floor(t)) }, function(n) {
        return n.getMinutes()
...
! function() {
    ...
    function l() {
        ...
        return e.parallel = function(e) {
            return arguments.length ? (a = Math.tan((n = (t = e * pa / 180) > 0 ? 1 : -1) * t), r(t)) : 180 * (t / pa)
        }, e.stream = function(r) {
            var i = e.rotate(),
                h = o(r),
                u = (e.rotate([0, 0]), o(r));
    ...
    function U(t, n) {
        for (var a = (1 + wa) * Math.sin(n), r = 0, e = 1 / 0; 10 > r && Math.abs(e) > da; r++) n -= e = (n + Math.sin(n) - a) / (1 + Math.cos(n));
    ...
    function $() {
        ...
        return o.radius = function(o) {
            return arguments.length ? (a = Math.cos(n = o * ma), r = Math.sin(n), e(n, t)) : n * ya
        }, o.lobes = function(a) {
    ...
    function bn() {
        ...
        return a.parallel = function(r) {
            ...
            return arguments.length ? (r.call(a, [n[0], n[1] - 180 * (t / pa)]), o.origin([-n[0], -n[1]]), a) : (n = r.call(a), n[1] += 180 * (t / pa), n)
        }, a.stream = function(t) {
    ...
    function pn(t, n) {
        ...
        return arguments.length < 2 && (n = t), 1 === n ? Ga : 1 / 0 === n ? qn : (a.invert = function(a, r) {
    ...
    function mn(t, n) {
        for (var a, r = Math.sin(n) * (0 > n ? 2.43763 : 2.67595), e = 0; 20 > e && (n -= a = (n + Math.sin(n) - r) / (1 + Math.cos(n)), !(Math.abs(a) < da)); e++);
    ...
    function xn(t, n) {
        return Math.abs(n) > Da ? (t = Ea(t, n), t[1] -= n > 0 ? La : -La, t) : E(t, n)
    }
    ...
    function Dn(t, n) {
        for (var a, r = (1 + Math.SQRT1_2) * Math.sin(n), e = n, o = 0; 25 > o && (e -= a = (Math.sin(e / 2) + Math.sin(e) - r) / (.5 * Math.cos(e / 2) + Math.cos(e)), !(Math.abs(a) < da)); o++);
        return [t * (1 + 2 * Math.cos(e) / Math.cos(e / 2)) / (3 * Math.SQRT2), 2 * Math.sqrt(3) * Math.sin(e / 2) / Math.sqrt(2 + Math.SQRT2)]
    }

    function Ln(t, n) {
        for (var a, r = Math.sqrt(6 / (4 + pa)), e = (1 + pa / 4) * Math.sin(n), o = n / 2, i = 0; 25 > i && (o -= a = (o / 2 + Math.sin(o) - e) / (.5 + Math.cos(o)), !(Math.abs(a) < da)); i++);
    ...
    var Ma = {
        ...
        fa = {
            ...
            result: function() {
                var t = sa.length ? sa.length < 2 ? { type: "Point", coordinates: sa[0] } : { type: "MultiPoint", coordinates: sa } : null;
                return sa = [], t
            }
        },
        va = {
            lineStart: a,
            point: function(t, n) { sa.push([t, n]) },
            lineEnd: function() { sa.length && (ca.push(sa), sa = []) },
            result: function() {
                var t = ca.length ? ca.length < 2 ? { type: "LineString", coordinates: ca[0] } : { type: "MultiLineString", coordinates: ca } : null;
                return ca = [], t
            }
        },
        la = {
    ...
    }).raw = k, (d3.geo.bottomley = function() {
        var t = pa / 6,
    ...
    (d3.geo.bromley = function() {
        return Sa(ka)
    }).raw = ka, (d3.geo.chamberlin = z).raw = _, G.invert = function(t, n) {
        var a = (a = n / qa - 1) * a;
        ...
        return x(C)
    }).raw = C, D.invert = function(t, n) {
        var a = Math.sqrt(3),
            r = 3 * h(n / (a * qa));
        return [qa * t / (a * (2 * Math.cos(2 * r / 3) - 1)), r]
    }, (d3.geo.craster = function() {
        return Sa(D)
    }).raw = D, (d3.geo.cylindricalEqualArea = function() {
        return x(L)
    }).raw = L, (d3.geo.cylindricalStereographic = function() {
        return x(O)
    ...
    (d3.geo.fahey = function() {
        ...
        return Sa(X)
    }).raw = X, d3.geo.gilbert = function(t) {
        function n(n) {
        ...
        return t.invert && (n.invert = function(n) {
            return n = t.invert(n), n[0] *= 2, n[1] = 2 * Math.atan(Math.sin(n[1] * ma)) * ya, n
        }), n.stream = function(n) {
            n = t.stream(n);
            var r = a.stream({ point: function(t, a) { n.point(.5 * t, h(Math.tan(.5 * -a * ma)) * ya) }, lineStart: function() { n.lineStart() }, lineEnd: function() { n.lineEnd() }, polygonStart: function() { n.polygonStart() }, polygonEnd: function() { n.polygonEnd() } });
            return r.sphere = function() { n.sphere() }, r.valid = !1, r
        }, n
    };
    ...
    }, (d3.geo.hammer = wn).raw = pn, mn.invert = function(t, n) {
    ...
    Tn.invert = function(t, n) {
        ...
        return Sa(xn)
    }).raw = xn, En.invert = function(t, n) {
        return [2 / 3 * pa * t / Math.sqrt(pa * pa / 3 - n * n), n]
    }, (d3.geo.kavrayskiy7 = function() {
        return Sa(En)
    }).raw = En, (d3.geo.lagrange = Pn).raw = kn, _n.invert = function(t, n) {
        var a = Math.abs(t),
            r = Math.abs(n),
            e = pa / Math.SQRT2,
            o = da,
        ...
        return Sa(Bn)
    }).raw = Bn, (d3.geo.loximuthal = function() {
        return x(Fn).parallel(40)
    }).raw = Fn, jn.invert = function(t, n) {
    ...
    (d3.geo.peirceQuincuncial = function() {
    ...
    }).raw = Ya.raw, Jn.invert = function(t, n) {
        if (Math.abs(n) < da) return [t, 0];
        var a, r = t * t + n * n,
            e = .5 * n,
            o = 10;
        ...
        return Sa(Jn)
    }).raw = Jn, (d3.geo.rectangularPolyconic = function() {
        return x(Kn)
    }).raw = Kn;
    var Za = [
        [.9986, -.062],
    ...
    Za.forEach(function(t) { t[1] *= 1.0144 }), Nn.invert = function(t, n) {
        ...
        return Sa(Nn)
    }).raw = Nn, (d3.geo.satellite = Wn).raw = Vn, Xn.invert = function(t, n) {
        var a = n / 1.70711,
            r = Math.sin(pa / 4 * a);
        return [t / (.74482 - .34588 * r * r), 2 * Math.atan(a)]
    }, (d3.geo.times = function() {
        return Sa(Xn)
    }).raw = Xn, (d3.geo.twoPointEquidistant = Zn).raw = Yn, (d3.geo.twoPointAzimuthal = ta).raw = $n, na.invert = function(t, n) {
        if (Math.abs(n) < da) return [t, 0];
...
! function(n, t) { "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(n.topojson = n.topojson || {}) }(this, function(n) {
    "use strict";
    ...
    function r(n) {
        ...
        var r, e, o = n.scale[0],
            ...
            u = n.translate[0],
            f = n.translate[1];
        return function(n, t) { t || (r = e = 0), n[0] = (r += n[0]) * o + u, n[1] = (e += n[1]) * i + f }
    }
    ...
    function f(n, t) {
        var r = { type: "Feature", id: t.id, properties: t.properties || {}, geometry: c(n, t) };
    ...
    function c(n, t) {
        function e(n, t) {
            t.length && t.pop();
            for (var r, e = l[0 > n ? ~n : n], i = 0, u = e.length; u > i; ++i) t.push(r = e[i].slice()), s(r, i);
            0 > n && o(t, u)
        }
        ...
        function u(n) {
            for (var t = [], r = 0, o = n.length; o > r; ++r) e(n[r], t);
        ...
        function a(n) {
            var t = n.type;
            return "GeometryCollection" === t ? { type: t, geometries: n.geometries.map(a) } : t in h ? { type: t, coordinates: h[t](n) } : null
        }
        var s = r(n.transform),
            l = n.arcs,
            h = {
    ...
    function a(n, t) {
        function r(t) {
            var r, e = n.arcs[0 > t ? ~t : t],
                o = e[0];
            return n.transform ? (r = [0, 0], e.forEach(function(n) { r[0] += n[0], r[1] += n[1] })) : r = e[e.length - 1], 0 > t ? [r, o] : [o, r]
        }

        function e(n, t) {
            for (var r in n) {
                var e = n[r];
                delete t[e.start], delete e.start, delete e.end, e.forEach(function(n) { o[0 > n ? ~n : n] = 1 }), f.push(e)
            }
        }
        var o = {},
            i = {},
        ...
        }), e(u, i), e(i, u), t.forEach(function(n) { o[0 > n ? ~n : n] || f.push([n]) }), f
    }
    ...
    function l(n, t, r) {
        ...
        function o(n) { n.forEach(e) }

        function i(n) { n.forEach(o) }

        function u(n) { "GeometryCollection" === n.type ? n.geometries.forEach(u) : n.type in l && (c = n, l[n.type](n.arcs)) }
        var f = [];
        if (arguments.length > 1) {
            var c, s = [],
                l = { LineString: o, MultiLineString: i, Polygon: i, MultiPolygon: function(n) { n.forEach(i) } };
            u(t), s.forEach(arguments.length < 3 ? function(n) { f.push(n[0].i) } : function(n) { r(n[0].g, n[n.length - 1].g) && f.push(n[0].i) })
        } else
            for (var h = 0, p = n.arcs.length; p > h; ++h) f.push(h);
    ...
    function g(n, t) {
        ...
        var o = {},
            i = [],
            u = [];
        return t.forEach(function(n) { "Polygon" === n.type ? r(n.arcs) : "MultiPolygon" === n.type && n.arcs.forEach(r) }), i.forEach(function(n) {
            if (!n._) {
                var t = [],
                    r = [n];
                for (n._ = 1, u.push(t); n = r.pop();) t.push(n), n.forEach(function(n) { n.forEach(function(n) { o[0 > n ? ~n : n].forEach(function(n) { n._ || (n._ = 1, r.push(n)) }) }) })
            }
        }), i.forEach(function(n) { delete n._ }), {
            type: "MultiPolygon",
            arcs: u.map(function(t) {
                var r, i = [];
                if (t.forEach(function(n) { n.forEach(function(n) { n.forEach(function(n) { o[0 > n ? ~n : n].length < 2 && i.push(n) }) }) }), i = a(n, i), (r = i.length) > 1)
                    for (var u, f, c = 1, s = e(i[0]); r > c; ++c)(u = e(i[c])) > s && (f = i[0], i[0] = i[c], i[c] = f, s = u);
                return i
            })
        }
    }
    ...
    function y(n) {
        ...
        function r(n, r) { n.forEach(function(n) { t(n, r) }) }

        function e(n, t) { "GeometryCollection" === n.type ? n.geometries.forEach(function(n) { e(n, t) }) : n.type in f && f[n.type](n.arcs, t) }
        var o = {},
            u = n.map(function() {
                return []
            }),
            f = { LineString: t, MultiLineString: r, Polygon: r, MultiPolygon: function(n, t) { n.forEach(function(n) { r(n, t) }) } };
        n.forEach(e);
        for (var c in o)
            for (var a = o[c], s = a.length, l = 0; s > l; ++l)
                for (var h = l + 1; s > h; ++h) {
                    var p, v = a[l],
                        g = a[h];
                    (p = u[v])[c = i(p, g)] !== g && p.splice(c, 0, g), (p = u[g])[c = i(p, v)] !== v && p.splice(c, 0, v)
                }
        return u
    }
    ...
    function m() {
        ...
        function t(n, t) {
            for (;;) {
                var r = t + 1 << 1,
                    ...
                    u = t,
                    f = e[u];
                if (o > i && d(e[i], f) < 0 && (f = e[u = i]), o > r && d(e[r], f) < 0 && (f = e[u = r]), u === t) break;
        ...
        return r.push = function(t) {
            ...
            var i, u = r._;
            if (e[u] === r) return u !== --o && (i = e[o], (d(i, r) < 0 ? n : t)(e[i._ = u] = i, u)), u
        }, r
    }

    function E(n, t) {
        function o(n) { f.remove(n), n[1][2] = t(n), f.push(n) }
        var i = r(n.transform),
            u = e(n.transform),
            f = m();
        return t || (t = h), n.arcs.forEach(function(n) {
            var r, e, c, a, s = [],
                l = 0;
            for (e = 0, c = n.length; c > e; ++e) a = n[e], i(n[e] = [a[0], a[1], 1 / 0], e);
            for (e = 1, c = n.length - 1; c > e; ++e) r = n.slice(e - 1, e + 2), r[1][2] = t(r), s.push(r), f.push(r);
            for (e = 0, c = s.length; c > e; ++e) r = s[e], r.previous = s[e - 1], r.next = s[e + 1];
            for (; r = f.pop();) {
                var h = r.previous,
                    p = r.next;
                r[1][2] < l ? r[1][2] = l : l = r[1][2], h && (h.next = p, h[2] = r[2], o(h)), p && (p.previous = h, p[0] = r[0], o(p))
            }
            n.forEach(u)
        }), n
    }
    var M = "1.6.26";
    n.version = M, n.mesh = s, n.meshArcs = l, n.merge = v, n.mergeArcs = g, n.feature = u, n.neighbors = y, n.presimplify = E
});
